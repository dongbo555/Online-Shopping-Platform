    ...
    <div class="login_cont">
        <form target="_top" action="<c:url value='/UserServlet'/>" method="post" id="loginForm">
            ...
            <ul class="login">
                ...
                <li class="mb_10"><input type="text" name="username" id="username" class="login_input user_icon input"></li>
                <li class="l_tit">&nbsp; <label id="loginnameError" class="error"></label></li>
                <li class="l_tit">密码</li>
                <li class="mb_10"><input type="password" name="password" id="password" class="login_input user_icon input"></li>
                <li class="l_tit">&nbsp; <label id="loginpassError" class="error"></label></li>
                <li class="l_tit">&nbsp; <label id="msg" class="error">${msg}</label></li>
                <%--<li class="autoLogin"><input type="checkbox" id="a1" class="checked"><label for="a1">自动登陆</label></li>--%>
                <li><input type="submit" id="submit" value="" class="login_btn"></li>
            </ul>
        </form>
